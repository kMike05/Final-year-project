		...
		<main>
			<div class="head-title">
				<div class="left">
                    ...
                    <?php
                        if(isset($_SESSION['add_animal'])){ 
							echo $_SESSION['add_animal']; 
                        	unset($_SESSION['add_animal']);

						}
                        if(isset($_SESSION['delete_animal'])){ 
							echo $_SESSION['delete_animal']; 
                        	unset($_SESSION['delete_animal']);
                ...
                <div class="head">
						...
						<a href="<?php echo SITEURL;?>HallerAdmin/manage-species.php?" class="btn-view">View Species</a>
						<a href="add-animal.php " class="btn-primary"><i class='bx bx-plus'></i></a>
					</div>
						...
						<tbody>
							...
							if($res==TRUE){
								...
								<td>
									...
									<a href="<?php echo SITEURL;?>HallerAdmin/update-animal.php?id=<?php echo $id;?>" class="btn-sec"><i class='bx bx-edit' ></i></a>
									<a href="<?php echo SITEURL;?>HallerAdmin/delete-animal.php?id=<?php echo $id;?>" class="btn-delete" onclick="return confirmDelete()"><i class='bx bxs-trash-alt'></i></a>
                                </span></td>
							</tr>
										<?php
