...
if(isset($_POST['submit'])){
    ...
    // Check user_form table
    $selectUser = "SELECT * FROM user_form WHERE email='$email'";
    ...
    $selectAdmin = "SELECT * FROM tbl_admin WHERE email='$email'";
  ...
  <body style="background: whitesmoke;" >
       ...
       <div class="container">
		...
		<div class="right">
            ...
            <p class="description"><a href="password-forget.php">Forgot Password?</a> 
            <?php
                            if(isset($error)){
