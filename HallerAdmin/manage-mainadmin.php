...
<br>
   ...
   <div class="table-data">
                ...
                <div class="head">
						...
						<a href="add-mainadmin.php" class="btn-primary"><i class='bx bx-user-plus' ></i></a>
					</div>
                ...
                <input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Search... ">
					...
					<table>
						...
						<tbody>
						<?php
// Assuming $_SESSION['admin_name'] holds the email or user ID of the logged-in admin
$loggedInAdminIdentifier = $_SESSION['admin_name'];

$sql="SELECT * FROM tbl_mainadmin";
    ...
    if($count>0){
        while($rows=mysqli_fetch_assoc($res)){
            ...
            <tr>
                ...
                <td><?=$role?></td>
                <td>
                    <a href="<?php echo SITEURL;?>HallerAdmin/update-mainpassword.php?id=<?php echo $id;?>" class="btn-pass"><i class='bx bxs-key' ></i></a>
                    <a href="<?php echo SITEURL;?>HallerAdmin/update-mainadmin.php?id=<?php echo $id;?>" class="btn-sec"><i class='bx bx-edit' ></i></a> 
                    <?php 
                    if ($email != $loggedInAdminIdentifier) { ?>
                        <a href="<?php echo SITEURL;?>HallerAdmin/delete-mainadmin.php?id=<?php echo $id;?>" class="btn-delete" onclick="return confirmDelete()"><i class='bx bxs-trash-alt'></i></a>
                    <?php } ?>
                </td>
            </tr>
            <?php
